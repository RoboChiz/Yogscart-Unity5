...
/// Vectors:
            ...
            float4 _HeightMap_var = tex2D(_HeightMap,TRANSFORM_TEX(node_9919, _HeightMap));
            float3 normalLocal = lerp(_NormalMap1_var.rgb,_NormalMap2_var.rgb,step(i.vertexColor.r,_HeightMap_var.rgb));
...
/// Diffuse:
            ...
            float3 node_5710 = lerp(_ColorMap1_var.rgb,_ColorMap2_var.rgb,step(i.vertexColor.r,_HeightMap_var.rgb));
