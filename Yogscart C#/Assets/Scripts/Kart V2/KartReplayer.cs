...
public class KartReplayer : MonoBehaviour
{
    ...
    public const char throttle = 't', steer = 's', drift = 'd', expectedSpeed = 'e', position = 'p', rotation = 'r', velocity = 'v', angularVelocity = 'a', recieveItem = 'i', itemAction = 'c', dropShield = 'u';
